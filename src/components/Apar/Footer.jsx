...
const Footer = ({ pixelId, produkBaru, footerImages, faqs }) => {
	const normalPrice = 168000;  // harga normal
  const promoPrice = 99000;    // harga promo
  const [isVisible, setIsVisible] = useState(false);
  const [currentValue, setCurrentValue] = useState(198000);
  ...
  useEffect(() => {
    if (isVisible && currentValue > 99000) {
      const step = (198000 - 99000) / 50; // adjust speed
    ...
    <div>
      <div className="space-y-2">
        <div className="text-center">
          ...
          <br />
          <p className="text-lg">
            Harga Normal <span className="line-through">168rb</span>
          </p>
