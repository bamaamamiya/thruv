...
const Form = () => {
  ...
  try {
    ...
    ooe(
      ...
      "66db34cae9e96835230df12a",
      "66db36825dd40557130e6824",
      "oo-embed-form-pel-tarik-9629",
      {
        mode: "page",
    ...
    <div id="form">
      <div class="ooef">
        <form
          ...
          data-product-slug="pel-tarik"
          data-product-id="66db34cae9e96835230df12a"
          id="oo-embed-form-pel-tarik-9629"
