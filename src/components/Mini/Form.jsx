...
const Form = () => {
  ...
  try {
    ...
    ooe(
      ...
      "674f7261592324503406bd54",
      null,
      "oo-embed-form-Thruvclean-Mini-7273",
      {
        mode: "page",
    ...
    <div id="form">
      <div class="ooef">
        <form
          ...
          data-product-slug="Thruvclean-Mini"
          data-product-id="674f7261592324503406bd54"
          id="oo-embed-form-Thruvclean-Mini-7273"
