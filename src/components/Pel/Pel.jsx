    ...
    <div className="m-2">
      ...
      <div>
        ...
        <div className="text-xl space-y-2">
          ...
          <div className="text-center">
            ...
            <p className="font-bold text-center">
              Apa itu "Pel Karet Anti Pegal " ?
            </p>
            <p>
              "Pel Anti Pegal" adalah pel yang bisa memeras kainnya sendiri.
            </p>
            <p>
          ...
          <p className="font-bold text-center text-2xl m-2">
            Kenapa Anda Harus Punya "Pel anti Pegal" ini ?
          </p>
        ...
        <div className="grid justify-center items-center space-y-4">
          <img
            src="images/pel/gambar1.webp"
            alt="product1"
            width="640"
            height="360"
          />
          <img
            src="images/pel/newpics.webp"
            alt="product2"
            width="640"
            height="360"
          />
          <img
            src="images/pel/newpics1.webp"
            alt="product2"
            width="640"
            height="360"
          />
          <img
            src="images/pel/product4.webp"
            alt="product2"
            width="640"
            height="360"
          />
          <img
            src="images/pel/serap.webp"
            alt="product2"
            width="640"
            height="360"
          />
          <img
            src="images/pel/q.webp"
            alt="product2"
            width="640"
            height="360"
          />
        ...
        <div>
          <div className="grid justify-center items-center m-2">
            ...
            <br />
            <img
              src="images/pel/1.webp"
              alt="testimoni"
              width="640"
              height="360"
            />
            <img
              src="images/pel/2.webp"
              alt="testimoni"
              width="640"
              height="360"
            />
            <img
              src="images/pel/3.webp"
              alt="testimoni"
              width="640"
              height="360"
            />
