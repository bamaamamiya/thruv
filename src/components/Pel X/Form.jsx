...
const Form = () => {
	...
	try {
		...
		ooe('init', '666cb298b1eb0751550d4892', '67754bcce77fa95ae6038461', '67754bcce77fa95ae6038462', 'oo-embed-form-pel-tarik-x-1504', {"mode":"page","action":"Klik untuk pemesanan","title":"Form Pemesanan","triggerPixel":false,"triggerGtm":false});
		if (!window.jQuery) {
			!function(w, d, e, v, id, t, s) {
			if (d.getElementById(id)) return;
			t = d.createElement(e);t.async = !0;t.src = v;t.id = id;
    ...
    return (
        <div id="form">
           <div class="ooef">
	<form class="orderonline-embed-form" data-username="thruvshop" data-product-slug="pel-tarik-x" data-product-id="67754bcce77fa95ae6038461" id="oo-embed-form-pel-tarik-x-1504" data-origin="orderonline">
