...
const Form = () => {
        ...
        try {
            ...
            ooe('init', '666cb298b1eb0751550d4892', '668aac9df524ea15150edb70', '668aac9df524ea15150edb72', 'oo-embed-form-gun-massager-alat-pijat-terapi-relaksasi-otot-4-in-1-4416', { "mode": "page", "action": "Klik untuk pemesanan", "title": "Form Pemesanan", "triggerPixel": false, "triggerGtm": false });
            if (!window.jQuery) {
                !function (w, d, e, v, id, t, s) {
                    if (d.getElementById(id)) return;
                    t = d.createElement(e); t.async = !0; t.src = v; t.id = id;
