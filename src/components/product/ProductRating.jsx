  ...
  return (
    <div className="flex items-center gap-2 mt-1 flex-wrap">
      ...
      <div className="flex items-center gap-1 text-xs">
        <span className="font-medium text-gray-500">Rated</span>
      ...
      {/* Badge */}
      <div className="bg-black text-white text-[10px] font-medium px-2 py-[2px] rounded">
        {badge}
      </div>
    </div>
  );
