...
const Form = () => {
  ...
  try {
    if (typeof xEmbedScript != "function") {
      var xEmbedScript = function () {
        !(function (w, d, e, v, id, t, s) {
          ...
          document,
          "script",
          "https://cdn.orderonline.id/js/embed-v2-slim.min.js?v=8.0.4",
          "oo-embed-js"
        );
      };
    }
    ...
    ooe(
      "init",
      "666cb298b1eb0751550d4892",
      "675d3536567ac467840095a8",
      "675d3536567ac467840095aa",
      "oo-embed-form-boa-eye-cream-krim-penghilang-mata-panda-dan-garis-halus-3761",
      {
        mode: "page",
    ...
    <div id="form">
      <div class="ooef">
        <form
          ...
          data-product-slug="boa-eye-cream-krim-penghilang-mata-panda-dan-garis-halus"
          data-product-id="675d3536567ac467840095a8"
          id="oo-embed-form-boa-eye-cream-krim-penghilang-mata-panda-dan-garis-halus-3761"
