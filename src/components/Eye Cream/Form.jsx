...
const Form = () => {
  if (typeof xLogError != 'function') {
	...
	try {
		...
		ooe('init', '666cb298b1eb0751550d4892', '676ed426d4ca112b230afc63', null, 'oo-embed-form-boa-eye-cream-krim-penghilang-mata-panda-dan-garis-halus-3565', {"mode":"page","action":"Klik untuk pemesanan","title":"Form Pemesanan","triggerPixel":false,"triggerGtm":false});
		if (!window.jQuery) {
			!function(w, d, e, v, id, t, s) {
			if (d.getElementById(id)) return;
			t = d.createElement(e);t.async = !0;t.src = v;t.id = id;
