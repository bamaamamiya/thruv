...
import Funnel from "../../components/FunnelPurchase";
import Faqs from "../../components/set/Faqs";
const Footer = ({
  pixelId,
  produkBaru,
  footerImages,
        ...
        <div className="text-center text-5xl font-bold " ref={promoRef}>
          <h1 className="text-redto">
            Rp {Math.floor(currentValue).toLocaleString("id-ID")}
				...
				<p className="text-lg text-center italic"> Bonus 4 kepala + Gratis Ongkir </p>
        </div>
        {/* <div className="text-center text-sm">
          <p className="font-semibold ">
            Bonus 4 kepala + Gratis Ongkir 
          </p>
        </div> */}
        <br />
